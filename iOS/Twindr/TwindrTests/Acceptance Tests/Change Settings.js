...
UIATarget.localTarget().delay(1);
target.frontMostApp().mainWindow().textViews()[0].tapWithOptions({tapOffset:{x:0.25, y:0.15}});
UIATarget.localTarget().delay(1);
target.frontMostApp().keyboard().tapWithOptions({tapOffset:{x:0.91, y:0.46}});
UIATarget.localTarget().delay(1);
target.frontMostApp().keyboard().typeString("Beaches");
UIATarget.localTarget().delay(1);
target.frontMostApp().mainWindow().buttons()["Save"].tap();
UIATarget.localTarget().delay(1);
