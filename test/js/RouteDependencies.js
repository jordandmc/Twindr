...
var jsRoutes = {}; (function(_root){
    ...
    _nS('controllers.MessagingController'); _root.controllers.MessagingController.getMoreMessages =
        function(matchID) {
            return _wA({method:"GET", url:"/" + "ajax/getMoreMessages" + _qS([(function(k,v) {return encodeURIComponent(k)+'='+encodeURIComponent(v)})("matchID", matchID)])})
        }
    ...
    _nS('controllers.MessagingController'); _root.controllers.MessagingController.receiveMessage =
        function(matchID) {
            return _wA({method:"GET", url:"/" + "js/receiveMessage/" + (function(k,v) {return v})("matchID", encodeURIComponent(matchID))})
        }
    ...
    _nS('controllers.MessagingController'); _root.controllers.MessagingController.sendMessage =
        function() {
            return _wA({method:"POST", url:"/" + "messaging"})
        }
